...
### Fixed
- Withdraw isolated, locally outmatched heroes before critical HP even outside offensive retreat control; stop shopping completion from directly adding a lone hero to assault.
